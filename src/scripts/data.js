...
const data = {
     ...
     '01-25-20_6:00PM':[['disco ball', 'bluelight'], 2.2],
     ...
     '02-08-20_3:00PM':[['bluelight', 'sunlight'], 1.8],
     ...
     '02-14-20_9:00PM':[['bluelight', 'halogen'], 1.4],
     ...
     '02-25-20_9:00PM':[['halogen', 'bluelight', 'white neon'], 4.6],
     '02-26-20_9:00AM':[['bluelight', 'sunlight'], 4.8],
     '02-26-20_3:00PM':[['sunlight'], 5.5],
     '02-26-20_9:00PM':[['white neon', 'bluelight'], 2]
};
